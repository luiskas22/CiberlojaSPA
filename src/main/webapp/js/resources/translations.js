...
const translations = {
    es: {
        ...
        services: {
            ...
            development: {
                ...
                description: "Ofrecemos soluciones integradas con Cegid Primavera para optimizar la gestión de su negocio. Desde la configuración inicial hasta el desarrollo de módulos personalizados, adaptamos el software a sus procesos. Ya sea una extensión para la gestión de inventario, automatización de facturación o integración con tiendas online.",
            },
            consulting: {
        ...
        empleados: {
            create: {
                ...
                provincia: "Provincia",
                pais: "País",
                direccionPlaceholder: "Ejemplo: Calle Real",
                dirViaPlaceholder: "Ejemplo: 8, 2ºD",
                localidadPlaceholder: "Ejemplo: Madrid",
                provinciaPlaceholder: "Ejemplo: Madrid",
                paisPlaceholder: "Ejemplo: España",
                saveBtn: "Guardar",
                backBtn: "Volver",
            },
            form_not_found: "Formulario no encontrado.",
            ...
            dniNie_required: "El DNI/NIE es obligatorio.",
            telefono_required: "El teléfono es obligatorio.",
            email_required: "El email es obligatorio.",
            password_required: "La contraseña es obligatoria.",
            tipoEmpleado_required: "Seleccione un tipo de empleado.",
            rol_required: "Seleccione un rol.",
            direccion_required: "La calle es obligatoria.",
            dirVia_required: "El número de la calle es obligatorio.",
            localidad_required: "La ciudad es obligatoria.",
            ...
            create_success: "Empleado creado exitosamente con ID: {id}",
            error_message: "Ocurrió un error. Por favor, intenta de nuevo.",
            create_error: "Error al crear empleado. Por favor, intenta de nuevo.",
            invalid_response_create: "Respuesta inválida del servicio al crear el empleado.",
        },
    ...
    pt: {
        ...
        services: {
            ...
            development: {
                ...
                description: "Oferecemos soluções integradas com o Cegid Primavera para otimizar a gestão da sua empresa. Desde a configuração inicial até ao desenvolvimento de módulos personalizados, adaptamos o software aos seus processos. Seja uma extensão para gestão de inventário, automação de faturação ou integração com lojas online.",
            },
            consulting: {
        ...
        alerts: {
            ...
            employeeOnlyOrders: "Apenas os funcionários podem procurar encomendas.",
            loginEmployee: "Por favor, inicie sessão como funcionário para procurar encomendas.",
        ...
        empleados: {
            create: {
                ...
                email: "Email",
                password: "Senha",
                tipoEmpleado: "Tipo de Funcionário",
                selectTipo: "Selecione um tipo",
                administrador: "Administrador",
                vendedor: "Vendedor",
                rol: "Cargo",
                selectRol: "Selecione um cargo",
                cliente: "Cliente",
                ...
                provincia: "Província",
                pais: "País",
                direccionPlaceholder: "Exemplo: Rua Real",
                dirViaPlaceholder: "Exemplo: 8, 2ºD",
                localidadPlaceholder: "Exemplo: Lisboa",
                provinciaPlaceholder: "Exemplo: Lisboa",
                paisPlaceholder: "Exemplo: Portugal",
                saveBtn: "Salvar",
                backBtn: "Voltar",
            },
            form_not_found: "Formulário não encontrado.",
            name_required: "O nome é obrigatório.",
            apellido1_required: "O primeiro sobrenome é obrigatório.",
            dniNie_required: "O NIF é obrigatório.",
            telefono_required: "O telefone é obrigatório.",
            email_required: "O email é obrigatório.",
            password_required: "A senha é obrigatória.",
            tipoEmpleado_required: "Selecione um tipo de funcionário.",
            rol_required: "Selecione um cargo.",
            direccion_required: "A rua é obrigatória.",
            dirVia_required: "O número da rua é obrigatório.",
            localidad_required: "A cidade é obrigatória.",
            provincia_required: "A província é obrigatória.",
            pais_required: "O país é obrigatório.",
            success_message: "Funcionário criado com sucesso.",
            create_success: "Funcionário criado com sucesso com ID: {id}",
            error_message: "Ocorreu um erro. Por favor, tente novamente.",
            create_error: "Erro ao criar funcionário. Por favor, tente novamente.",
            invalid_response_create: "Resposta inválida do serviço ao criar o funcionário.",
        },
    ...
    en: {
        ...
        home: {
            ...
            highlightedProducts: "Featured Products",
        },
        pedidos: {
            title: "My Orders",
        ...
        services: {
            ...
            development: {
                ...
                description: "We provide integrated solutions with Cegid Primavera to optimize your business management. From initial setup to the development of custom modules, we adapt the software to fit your processes. Whether it’s an extension for inventory management, billing automation, or integration with online store.",
            },
            consulting: {
                title: "IT Consulting",
        ...
        create: {
            ...
            provincia: "Province",
            pais: "Country",
            direccionPlaceholder: "Example: Real Street",
            dirViaPlaceholder: "Example: 8, 2nd Floor",
            localidadPlaceholder: "Example: Madrid",
            provinciaPlaceholder: "Example: Madrid",
            paisPlaceholder: "Example: Spain",
            saveBtn: "Save",
            backBtn: "Back",
        },
        form_not_found: "Form not found.",
        name_required: "Name is required.",
        apellido1_required: "First surname is required.",
        dniNie_required: "DNI/NIE is required.",
        telefono_required: "Phone is required.",
        email_required: "Email is required.",
        password_required: "Password is required.",
        tipoEmpleado_required: "Select an employee type.",
        rol_required: "Select a role.",
        direccion_required: "Street is required.",
        dirVia_required: "Street number is required.",
        localidad_required: "City is required.",
        provincia_required: "Province is required.",
        pais_required: "Country is required.",
        success_message: "Employee created successfully.",
        create_success: "Employee created successfully with ID: {id}",
        error_message: "An error occurred. Please try again.",
        create_error: "Error creating employee. Please try again.",
        invalid_response_create: "Invalid response from the service when creating the employee.",
    },
};
