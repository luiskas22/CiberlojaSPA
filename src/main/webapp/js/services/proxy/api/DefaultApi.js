...
export default class DefaultApi {
  ...
  */
  ...
  /**
   * Callback function to receive the result of the createEmpleado operation.
   * @callback moduleapi/DefaultApi~createEmpleadoCallback
   * @param {String} error Error message, if any.
   * @param {module:model/EmpleadoDTO{ data The data returned by the service call.
   * @param {String} response The complete HTTP response.
   */
   ...
   * @param {Object} opts Optional parameters
   * @param {module:model/EmpleadoDTO} opts.body 
   * @param {module:api/DefaultApi~createEmpleadoCallback} callback The callback function, accepting three arguments: error, data, response
   * data is of type: {@link <&vendorExtensions.x-jsdoc-type>}
   */
  createEmpleado(opts, callback) {
    opts = opts || {};
    let postBody = opts['body'];
